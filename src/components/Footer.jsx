    ...
    <footer className="bg-gray-200 py-12 px-5">
      <div className="container mx-auto">
        <div className="text-center">
          <h3 className="text-3xl leading-10 text-blue-800 font-bold mb-4">
          ...
          <div className="flex justify-center space-x-3">
            ...
            />
            <button className="font-bold rounded-lg text-white bg-blue-700 hover:bg-blue-600 cursor-pointer px-6 py-3 shadow-lg focus:outline-none">
              Subscribe
            </button>
          </div>
        </div>
