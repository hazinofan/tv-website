...
const WhatsAppButton = ({ phoneNumber = "447453930081", message = "Bonjour! Je suis intéressé par le prix actuel de l’abonnement Elite. Pourriez-vous s'il vous plaît fournir les détails?" }) => {
